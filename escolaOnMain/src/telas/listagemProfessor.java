...
public class listagemProfessor extends javax.swing.JFrame {
    ...
    private String[] colunas = {"id", "nome", "data de nascimento", "CPF", "Telefone", "disciplina", "login", "senha", "carga horária", "salário"};
    ...
    private void initComponents() {
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome", "Data de nascimento ", "CPF", "Telefone", "Disciplina", "Login", "Senha", "Carga Horária", "Salário"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Double.class
            };
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        if (getIdLinha() > 0) {
            telaAlterarProfessor tp = new telaAlterarProfessor();
            tp.setVisible(true);
            int id = getIdLinha();
            professorDAO d = new professorDAO();
            Professor p = d.buscar(id);
            tp.valoresPadrao(p);
        }
    ...
    public void atualizarTabela() {
        professorDAO d = new professorDAO();
        List<Professor> lista = d.listarProfessores();
        Professor p;
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            p = lista.get(i);
            String[] row = {
                Integer.toString(p.getId()), p.getNome(), p.getDataNascimento(), p.getCPF(), p.getTelefone(),
                p.getDisciplina(), p.getLogin(), p.getSenha(),
                Integer.toString(p.getCargaHoraria()), Double.toString(p.getSalario())
            };
            mt.addRow(row);
        }
        tabela.setModel(mt);
